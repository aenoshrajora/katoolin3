...
def main():
 ...
 \033[1;32m+ -- -- +=[ Author: Aenosh Rajora\033[1;m
...
4) Install Kali menu
5) Help
   \033[1;23mType \"gohome\" or \"back\" To come back\033[1;m
...
4) View the contents of sources.list file
   Type \"gohome\" or \"back\" To come back
					""")
                    repo = input(
                    ...
                    if repo == "1":
                        ...
                        cmd2 = os.system(
                            "echo '# Kali linux repositories | Added by Katoolin\ndeb http://http.kali.org/kali kali-rolling main contrib non-free' >> /etc/sudo apt/sources.list")
                    elif repo == "2":
                        cmd3 = os.system("sudo apt-get update -m")
                    elif repo == "3":
...
""")
                    ...
                    if repo == "y":
                        cmd1 = os.system(
                            "sudo add-apt-repository ppa:diesch/testing && apt-get update")
                        cmd = os.system(
                    ...
                    if repo == "y":
                        cmd1 = os.system("sudo apt-get install kali-menu")
                elif opcion0 == "5":
                    print("""
****************** +Commands+ ******************
...
0) Install all Information Gathering tools
						...
						""")
                            ...
                            if opcion2 == "1":
                                ...
                                cmd = os.system(
                                    "sudo apt-get install wget gnupg -y && wget http://apt.ntop.org/18.04/all/apt-ntop.deb && dpkg -i apt-ntop.deb")
                            elif opcion2 == "37":
...
0) Install all Web Applications tools
						...
						""")
                            ...
                            if opcion2 == "1":
                                ...
                                cmd = os.system(
                                    "sudo apt-get install cutycsudo apt")
                            elif opcion2 == "7":
                                cmd = os.system(
                                    "sudo apt-get install git && git clone https://github.com/stasinopoulos/commix.git commix && cd commix && python ./commix.py --install")
                            elif opcion2 == "8":
                                ...
                                cmd = os.system("sudo apt-get install w3af")
                            elif opcion2 == "34":
                                cmd = os.system(
                                ...
                                cmd = os.system("sudo apt-get install -y apache-users arachni bbqsql blindelephant burpsuite cutycsudo apt davtest deblaze dirb dirbuster fimap funkload grabber jboss-autopwn joomscan jsql maltego-teeth padbuster paros parsero plecost powerfuzzer proxystrike recon-ng skipfish sqlmap sqlninja sqlsus ua-tester uniscan vega w3af webscarab websploit wfuzz wpscan xsser zaproxy")
                            else:
                                print(
                                    "\033[1;31mSorry, that was an invalid command!\033[1;m")
                        while opcion1 == "5":
...
0) Install all Reporting Tools
						...
						""")
                            ...
                            if opcion2 == "1":
                                ...
                                cmd = os.system(
                                    "sudo apt-get install -y casefile sudo cutycapt dos2unix dradis keepnote magictree metagoofil nipper-ng pipal")
                            else:
                                print(
                                    "\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Exploitation Tools
						...
						""")
                            ...
                            if opcion2 == "1":
                                ...
                                cmd = os.system(
                                    "sudo apt-get install shellnoob")
                            elif opcion2 == "15":
                                cmd = os.system("sudo apt-get install sqlmap")
                            elif opcion2 == "16":
                                cmd = os.system(
                                ...
                                cmd = os.system(
                                    "sudo apt-get install -y armitage backdoor-factory cisco-auditing-tool cisco-global-exploiter cisco-ocs cisco-torch crackle jboss-autopwn linux-exploit-suggester maltego-teeth set shellnoob sqlmap thc-ipv6 yersinia beef-xss")
                            else:
                                print(
                                    "\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Stress Testing tools
						...
						""")
                            ...
                            opcion2 = input("\033[1;36mkat > \033[1;m")
                            if opcion2 == "1":
                                cmd = os.system("sudo apt-get install dhcpig")
                                ...
                                cmd = os.system("sudo apt-get install t50")
                            elif opcion2 == "12":
                                cmd = os.system(
...
0) Install all Hardware Hacking tools
						...
						""")
                            ...
                            if opcion2 == "1":
                                ...
                                cmd = os.system("sudo apt-get install arduino")
                            elif opcion2 == "4":
                                cmd = os.system("sudo apt-get install dex2jar")
                            elif opcion2 == "5":
                                cmd = os.system("sudo apt-get install sakis3g")
                            elif opcion2 == "6":
                                cmd = os.system("sudo apt-get install smali")
...
2) Squid3
				""")
                            ...
                            if opcion2 == "1":
                                ...
                                cmd = os.system("sudo apt-get install squid3")
                                print(" ")
                            elif opcion2 == "back":
                                inicio()
                            elif opcion2 == "gohome":
